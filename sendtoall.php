...
define('BOT_TOKEN', '266936680:AAGfgtR6z6ufzB_mgrBKVbATnRaF5zTa3aw');
...
Copy Right 2016©","parse_mode"=>"html"));
    ...
    }else if ($matches[0] == "/sendtoall"&& $chat_id == 20054161701) {
		...
		for($y=0;$y<count($banid);$y++)
      {
        apiRequest("sendMessage", array('chat_id' => $banid[$y], "text" => $sendtotext));
          ...
          apiRequest("sendMessage", array('chat_id' => 2005416170, "text" => "Sent To ".count($banid)." Members"));
...
apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🚀 ربات شما با مـوفقیت آپدیت شد ♻️"));
    ...
    else if ($matches[0] != "/update"&& $matches[1]==""&&$chat_id != 2005461170) {
      if (strpos($text, ":")) {
...
<b> by TeleSpeed Tm </b>";
    ...
    $bot_url    = "https://api.telegram.org/bot266936680:AAGfgtR6z6ufzB_mgrBKVbATnRaF5zTa3aw/"; 
...
🚀 @veryg0odebot"));
        ...
        }else if ($matches[0] != "/update"&&$matches[1] != ""&&$matches[2] != ""&&$chat_id == 2005461170) {
